...
class CreateQuizWidget extends StatefulWidget {
  ...
  static String routeName = 'CreateQuiz';
  static String routePath = '/createQuiz';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0x474B39EF),
