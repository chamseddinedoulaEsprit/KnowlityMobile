...
class QuizListWidget extends StatefulWidget {
  ...
  static String routeName = 'QuizList';
  static String routePath = '/quizList';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<QuizsetRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizsetRecord> quizListQuizsetRecordList = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                context.pushNamed(CreateQuizWidget.routeName);
              },
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/student-graduated-avatar-isolated-vector-11224949.jpg',
                                  width: 200.0,
                                  height: 200.0,
                                  fit: BoxFit.cover,
                                ),
                                ...
                                child: Container(
                                  ...
                                  child: Autocomplete<String>(
                                    ...
                                    optionsBuilder: (textEditingValue) {
                                      ...
                                      return quizListQuizsetRecordList
                                          .map((e) => e.quizName)
                                          .toList()
                                          .where((option) {
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(15.0, 15.0, 35.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: QuizSetsWidget(
                                      key: Key(
                                          'Keysmw_${listViewIndex}_of_${listViewQuizsetRecordList.length}'),
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return ListView.builder(
                              ...
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: searchedQuiz.length,
                              itemBuilder: (context, searchedQuizIndex) {
                                final searchedQuizItem =
                                    searchedQuiz[searchedQuizIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 12.0),
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'quizSetRef': serializeParam(
                                            searchedQuizItem.reference,
                                            ParamType.DocumentReference,
                                          ),
                                          'quizDuration': serializeParam(
                                            searchedQuizItem.duration,
                                            ParamType.int,
                                          ),
                                        }.withoutNulls,
                                      );
                                    ...
                                    child: QuizSetsWidget(
                                      key: Key(
                                          'Keyjpj_${searchedQuizIndex}_of_${searchedQuiz.length}'),
                                      title: searchedQuizItem.quizName,
                                      description: searchedQuizItem.description,
                                      totalQuestions:
                                          searchedQuizItem.totalQuestions,
                                      quizDuration:
                                          searchedQuizItem.duration.toDouble(),
                                      coverimage: searchedQuizItem.coverPhoto,
                                    ),
                                  ),
                                );
                              },
