...
import '/index.dart';
import 'add_article_widget.dart' show AddArticleWidget;
...
class AddArticleModel extends FlutterFlowModel<AddArticleWidget> {
  ...
  // Stores action output result for [Custom Action - geminApi] action in Button widget.
  String? geminiresponse;
  // Stores action output result for [Backend Call - API (imageupload)] action in Button widget.
  ApiCallResponse? apiResult5w6;
