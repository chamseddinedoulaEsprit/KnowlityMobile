                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            dateTimeFormat(
                                "MMMMEEEEd", widget!.article!.createdAt!),
                            style:
                          ...
                          child: StreamBuilder<List<CommentsRecord>>(
                            stream: queryCommentsRecord(
                              queryBuilder: (commentsRecord) =>
                                ...
                                'article_id',
                                isEqualTo: widget!.article?.reference,
                              ),
                            ),
                                  ...
                                  Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.geminireply =
                                            await actions.geminiApiBadWords(
                                          _model.textController.text,
                                        );
                                        if (_model.geminireply == true) {
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title: Text('Error'),
                                                content: Text(
                                                    'Comment contain bad words or harassment'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
