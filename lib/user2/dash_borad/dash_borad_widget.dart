...
import 'dash_borad_model.dart';
export 'dash_borad_model.dart';

class DashBoradWidget extends StatefulWidget {
  const DashBoradWidget({super.key});

  static String routeName = 'DashBorad';
  static String routePath = '/dashBorad';
...
class _DashBoradWidgetState extends State<DashBoradWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashBoradModel());
                      ...
                      children: [
                        ...
                        AuthUserStreamWidget(
                          builder: (context) => Text(
                            valueOrDefault(currentUserDocument?.pseudo, ''),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.inter(
