...
class _CreateCourseWidgetState extends State<CreateCourseWidget> {
  ...
  void initState() {
    ...
    _model.enseignantTextController ??= TextEditingController();
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.enseignantTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        FFButtonWidget(
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await CoursRecord.collection
                                .doc()
                                .set(createCoursRecordData(
                            ...
                            _model.message =
                                await actions.formatFacebookMessage(
