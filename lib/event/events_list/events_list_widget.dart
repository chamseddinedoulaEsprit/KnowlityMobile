  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EventsRecord>>(
      stream: queryEventsRecord(
        queryBuilder: (eventsRecord) => eventsRecord.orderBy('titre'),
      ),
      builder: (context, snapshot) {
        ...
        List<EventsRecord> eventsListEventsRecordList = snapshot.data!;
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (valueOrDefault(
                                  ...
                                  'etudiant') {
                                context.pushNamed(
                                    ListeCoursEtudiantsWidget.routeName);
                              } else {
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      if (valueOrDefault(currentUserDocument?.role, '') ==
                          'etudiant') {
                        context.pushNamed(ReservedeventsWidget.routeName);
                      } else {
                        context.pushNamed(TeacherEventsWidget.routeName);
                      }
                    },
                  ),
                ),
                    ...
                    if (!FFAppState().SearchEventisActive)
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final eventslist =
                                eventsListEventsRecordList.toList();
