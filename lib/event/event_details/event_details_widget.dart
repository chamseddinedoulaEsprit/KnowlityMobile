                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 12.0),
                                            child: Text(
                                              'Start Date : ${dateTimeFormat("EEE  MMM d , HH:mm", widget!.eventdetails?.startDate)}',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .labelMedium
                                                  .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 12.0),
                                            child: Text(
                                              'End Date : ${dateTimeFormat("EEE  MMM d , HH:mm", widget!.eventdetails?.endDate)}',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .labelMedium
                                                  .override(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: Text(
                                                  '${widget!.eventdetails?.seatsAvailable?.toString()} : Seats Available',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelSmall
                                                      .override(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    context.pushNamed(
                      ...
                      queryParameters: {
                        'eventreservation': serializeParam(
                          widget!.eventdetails,
                          ParamType.Document,
                        ),
                      }.withoutNulls,
                      extra: <String, dynamic>{
                        'eventreservation': widget!.eventdetails,
                      },
                    );
                  },
                  child: Container(
