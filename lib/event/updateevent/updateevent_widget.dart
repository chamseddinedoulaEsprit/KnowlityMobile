...
import 'updateevent_model.dart';
export 'updateevent_model.dart';
...
class UpdateeventWidget extends StatefulWidget {
  ...
  static String routePath = '/updateevent';
...
class _UpdateeventWidgetState extends State<UpdateeventWidget> {
  ...
  void initState() {
    ...
    _model.titleTextController ??=
        TextEditingController(text: widget!.eventdetails?.titre);
    _model.titleFocusNode ??= FocusNode();

    _model.decriptionTextController ??=
        TextEditingController(text: widget!.eventdetails?.description);
    ...
    _model.locationTextController ??=
        TextEditingController(text: widget!.eventdetails?.locationName);
    _model.locationFocusNode ??= FocusNode();

    _model.seatsTextController ??= TextEditingController(
        text: widget!.eventdetails?.seatsAvailable?.toString());
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              if ((_model.titleTextController.text != null &&
                                  ...
                                  (_model.categoryChoiceValue != null &&
                                      _model.categoryChoiceValue != ''))
                                Align(
                                  alignment: AlignmentDirectional(1.0, 0.0),
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.reponse =
                                          await EventDescriptionCall.call(
                                        title: _model.titleTextController.text,
                                        location:
                                            _model.locationTextController.text,
                                        category: _model.categoryChoiceValue,
                                        startdate: dateTimeFormat(
                                            "MEd", _model.datePicked1),
                                      );

                                      safeSetState(() {
                                        _model.decriptionTextController?.text =
                                            EventDescriptionCall
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if ((_model.apiResultbrg?.succeeded ??
                                      true)) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          (_model.apiResultbrg?.succeeded ??
                                                  true)
                                              .toString(),
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context)
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 16.0, 0.0),
                            child: TextFormField(
                              controller: _model.seatsTextController,
                              ...
                              validator: _model.seatsTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [
                                if (!isAndroid && !isiOS)
                                  TextInputFormatter.withFunction(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowChoiceChips(
                                      ...
                                      multiselect: false,
                                      initialized:
                                          _model.typeChoiceValue != null,
                                      alignment: WrapAlignment.start,
                                      controller:
                                          _model.typeChoiceValueController ??=
                                              FormFieldController<List<String>>(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'Event have been deleted successfully !'),
                                            actions: [
                                              TextButton(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await widget!.eventdetails!.reference
                                        ...
                                        description: _model
                                            .decriptionTextController.text,
                                        seatsAvailable: int.tryParse(
                                            _model.seatsTextController.text),
                                        image: getJsonField(
                                          (_model.apiResultbrg?.jsonBody ?? ''),
                                          r'''$.data.url''',
                                        ).toString(),
                                        startDate: _model.datePicked1,
                                        endDate: _model.datePicked2,
                                        category: _model.categoryChoiceValue,
                                        type: _model.typeChoiceValue,
