...
import 'fdvdfvd_model.dart';
export 'fdvdfvd_model.dart';

class FdvdfvdWidget extends StatefulWidget {
  const FdvdfvdWidget({
    super.key,
    this.idtest,
  ...
  final DocumentReference? ifoucr;

  static String routeName = 'fdvdfvd';
  static String routePath = '/fdvdfvd';

  @override
  State<FdvdfvdWidget> createState() => _FdvdfvdWidgetState();
}

class _FdvdfvdWidgetState extends State<FdvdfvdWidget> {
  late FdvdfvdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FdvdfvdModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ReponseRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final fdvdfvdReponseRecord = snapshot.data!;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await widget!.idreponse!
                                  .update(createReponseRecordData(
                                note: _model.textController1.text,
                                remarque: _model.textController2.text,
                              ));
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<QuestionRecord>(
                              stream: QuestionRecord.getDocument(
                                  fdvdfvdReponseRecord.questionid!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
